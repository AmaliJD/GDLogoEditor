...
public class TransparentBackgroundScreenshotRecorder : MonoBehaviour
{
    ...
    public string folderBaseName = "GD Logo Text Images";
    ...
    void SavePng()
    {
        ...
        string name = folderName + "/" + System.DateTime.Now.Year + "-" + System.DateTime.Now.Month + "-" + System.DateTime.Now.Day + "-" +
            System.DateTime.Now.Hour + "-" + System.DateTime.Now.Minute + "-" + System.DateTime.Now.Second + "-" + System.DateTime.Now.Millisecond + ".png";
        Debug.Log(name);
