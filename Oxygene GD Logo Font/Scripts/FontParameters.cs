...
public class FontParameters : MonoBehaviour
{
    ...
    public TextMeshPro text_bg, text_highlight, text_main, text_secondary, text_under;
    ...
    public Slider outline_slider, border_slider, shade_slider, shadow_slider, blur_slider, x_slider, y_slider, hue_slider, sat_slider;
    public Text outlineVal, borderVal, shadeVal, shadowVal, blurVal, xVal, yVal, hueVal, satVal;

    public VolumeProfile volume;
    private ColorAdjustments colorAdj;

    private Color initMain, initSec, initUnder, initHigh, initBor, initOut, initShad;
    private float initOutVal, initBorVal, initShadeVal, initShadVal, initBlurVal, initXVal, initYVal;
    ...
    //private Color initMain, initSec, initUnder, initHigh, initBor, initOut, initShad;
    //private float initOutVal, initBorVal, initShadVal, initBlurVal, initXVal, initYVal;
