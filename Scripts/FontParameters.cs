...
public class FontParameters : MonoBehaviour
{
    ...
    public TextMeshPro text_bg, text_border, text_highlight, text_highlight2, text_main, text_secondary, text_under;
    ...
    void LateUpdate()
    {
        ...
        text_border.GetComponent<TMP_Text>().outlineColor = border_color.CurrentColor;
        text_border.GetComponent<TMP_Text>().outlineColor = border_color.CurrentColor;
        ...
        text_border.GetComponent<TMP_Text>().outlineWidth = border_slider.value/100f;
        text_border.GetComponent<TMP_Text>().outlineWidth = border_slider.value / 100f;
        text_border.fontSharedMaterial.SetFloat(ShaderUtilities.ID_FaceDilate, border_slider.value / 100f);
        text_border.fontSharedMaterial.SetFloat(ShaderUtilities.ID_FaceDilate, border_slider.value / 100f);
        ...
        if(shade_slider.value != 0)
        {
            int rev = shade_slider.value < 0 ? 1 : -1;
            text_under.transform.localPosition = new Vector3(0, .0002f * text_under.fontSize * rev, 0);
        }
        else
        {
            text_under.transform.localPosition = new Vector3(0, 0, 0);
        }
